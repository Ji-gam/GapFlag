    ...
    ("carprofen", "dog"): {
        ...
        "risk": {
            "r1": {
                ...
                "summary": "사람 임상 중단 이력 확인 안 됨",
                "source_url": "https://platform.opentargets.org/",
            },
            "r2": {
                "value": 45.0,
                "label": "동물 이상반응",
                "source_name": "openFDA ADAE",
                "summary": "최근 보고 이상반응 다수",
                "source_url": "https://open.fda.gov/apis/animalandveterinary/event/",
            },
            "r3": {
                "value": 20.0,
                "label": "승인·철회 이력",
                "source_name": "FDA Green Book",
                "summary": "승인 유지 중",
                "source_url": "#",
            },
            "r4": {
